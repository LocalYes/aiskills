...
for all_skills in top_skills_data:
    ...
    top_cluster_skills_data.append(top_skills)
"""Expand skills from the clusters"""



"""Filter skills using ChatGPT"""
skills_filtered = chatgpt_skills_filtering(example_data, top_cluster_skills_data, "gpt-4.1-mini")
